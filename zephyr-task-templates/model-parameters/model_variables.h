...
#include "tflite-model/tflite_learn_38_compiled.h"
#include "edge-impulse-sdk/classifier/ei_model_types.h"
#include "edge-impulse-sdk/classifier/inferencing_engines/engines.h"

const char* ei_classifier_inferencing_categories[] = { "bicep", "idle", "shoulder" };
...
const ei_config_tflite_eon_graph_t ei_config_tflite_graph_38 = {
    .implementation_version = 1,
    .model_init = &tflite_learn_38_init,
    .model_invoke = &tflite_learn_38_invoke,
    .model_reset = &tflite_learn_38_reset,
    .model_input = &tflite_learn_38_input,
    .model_output = &tflite_learn_38_output,
};

const ei_learning_block_config_tflite_graph_t ei_learning_block_config_38 = {
    .implementation_version = 1,
    ...
    .quantized = 1,
    .compiled = 1,
    .graph_config = (void*)&ei_config_tflite_graph_38
};

const uint8_t ei_learning_blocks_size = 1;
const uint32_t ei_learning_block_38_inputs[1] = { 7 };
const uint8_t ei_learning_block_38_inputs_size = 1;
const ei_learning_block_t ei_learning_blocks[ei_learning_blocks_size] = {
    {
        38,
        false,
        &run_nn_inference,
        (void*)&ei_learning_block_config_38,
        EI_CLASSIFIER_IMAGE_SCALING_NONE,
        ei_learning_block_38_inputs,
        ei_learning_block_38_inputs_size,
        1
    },
};
...
const ei_impulse_t impulse_21940_0 = {
    .project_id = 21940,
    .project_owner = "M-F",
    .project_name = "imu-exercises-project-1",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 20,

    .nn_input_frame_size = 33,
    .raw_sample_count = 153,
    .raw_samples_per_frame = 3,
    .dsp_input_frame_size = 153 * 3,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 6.5359477124183005,
    .frequency = 153,
    ...
    .fusion_string = "roll + pitch + yaw + qX + qY + qZ + qW",
    .slice_size = (153/4),
...
ei_impulse_handle_t impulse_handle_21940_0 = ei_impulse_handle_t( &impulse_21940_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_21940_0;
