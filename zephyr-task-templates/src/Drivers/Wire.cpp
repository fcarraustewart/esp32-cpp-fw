...
void arduino::ZephyrI2C::setClock(uint32_t freq) {
	...
	if (i2c_configure(i2c_dev, i2c_cfg)) {
		LOG_DBG("Success to configure i2c interface.");
	}
}
...
#elif DT_NODE_EXISTS(DT_NODELABEL(i2c0))
arduino::ZephyrI2C Wire(DEVICE_DT_GET(DT_NODELABEL(i2c0)));
#endif